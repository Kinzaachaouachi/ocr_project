...
def calculate_overall_score(model_id: str) -> float:
    """Calcule un score global pondéré pour un modèle."""
...
def get_best_model_for_task(task_type: str, language: str = "fr") -> str:
    """Recommande le meilleur modèle pour un type de tâche."""
    recommendations = {
        "document": "docling",
        "image": "paddleocr",
        "handwritten": "trocr",
...
def get_model_info(model_id: str) -> dict:
    """Retourne les informations complètes d'un modèle avec score global."""
    if model_id not in MODEL_MATRIX:
        return {}
...
def compare_models(model_ids: list = None) -> dict:
    """Compare plusieurs modèles selon tous les critères."""
    if model_ids is None:
        model_ids = list(MODEL_MATRIX.keys())

    comparison = {"models": {}, "rankings": {}}
